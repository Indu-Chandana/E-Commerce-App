...
const AuthMain = ({ navigation }) => {
    ...
    // In after page load animationState hasn't values. Therefore we face some dificulties in when go to signIn & signUp.
    React.useEffect(() => {
    ...
    function renderSignUp() {
        ...
        return (
            <MotiView
                ...
                style={{
                    marginTop: SIZES.padding,
                    // height: SIZES.height * 0.55 - I this case It would be controlled by the animation state
                }}
            >
                <Shadow>
                    <View
